...
#     "player.png").convert_alpha(), (100, 100))
...
def create_enemy():
    ...
    enemy_move = [-random.randint(4, 8), 0]
    return [enemy, enemy_rect, enemy_move]


def create_bonus():
    bonus_size = (20, 20)
    bonus = pygame.transform.scale(pygame.image.load('bonus.png'), (70, 100))
    bonus_rect = pygame.Rect(random.randint(500, HEIGHT), 0, *bonus_size)
